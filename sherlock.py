...
import csv, json, os, platform, re, sys, random, requests
...
module_name = "Sherlock (Edited by Arilis): Find Usernames Across Social Networks"
__version__ = "0.0.1"
amount = 0
...
def main():
    ...
    for username in args.username:
        ...
        if args.output:
            ...
            file = open(os.getcwd() + "\\results\\" + username + ".txt", "w", encoding="utf-8")
        else:
            file = open(os.getcwd() + "\\results\\" + username + ".txt", "w", encoding="utf-8")
